# The R script called plot4.R makes plot (line) of 
# Global_active_power, Voltage, Energy sub-metering and Global_reactive_power
# of 1st and 2nd February 2007 into same figure.
...
# --- plot 4 to file plot4.png
png('plot4.png')
# Set up the plot window for two rows and two columns 
par(mfrow=c(2,2))

# Global_active_power
plot(householdValues$DateTime, householdValues$Global_active_power, 
  type = "l", ylab = "Global Active Power", xlab = "")

# Voltage
plot(householdValues$DateTime, householdValues$Voltage, 
...
plot(householdValues$DateTime, householdValues$Global_reactive_power,
